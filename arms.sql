...
select s.id, s.fio, s.tabn, apl.NAME 
from staff s, applist_staff ap, applist apl
where (s.id=ap.id) and (apl.CODEAPP=ap.CODEAPP)
order by s.fio;
/*
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEPkb
'' SIG '' ojnGDYPeSBkp5IQ1+c6gggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBAhnul3V09DbW4l
'' SIG '' DfNzyAR4MA0GCSqGSIb3DQEBAQUABEBNf0IOgoOz4Oyj
'' SIG '' +SqkEDrNC+B/OkI9tE3HbbiJR+3giYtX6oBae3lqXBTv
'' SIG '' SA2o1Rf5A7LHCxRwu40t7uBckQ2h
