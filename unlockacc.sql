-- SEC_AUDIT active account
prompt ------------------------------------------

prompt _ перелiк дiючих акаунтiв користувачiв (unlockacc.sql)
...
select st.TABN, st.fio cUser, 
 TO_CHAR(io.io_date, 'dd/mm/yyyy HH24:MI:SS') as Input
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEA+u
'' SIG '' lcwMfaKcEhbHq/2dJBOgggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBDGjjbZXzydGgcO
'' SIG '' 97oo0dQWMA0GCSqGSIb3DQEBAQUABEAv8e5HH3RSMLTp
'' SIG '' rZ4JpfrfKqKzlpG1KY4Bggms/ofYmsz/nGXpYL5oWVTI
'' SIG '' 7Re+tfMDlH1DzRMn9D6Wkujaq3PK
