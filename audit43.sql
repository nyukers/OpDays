...
prompt _ Журнал АРМу безпеки  (audit43.sql)
prompt _ АРМ безпека: Logins !
...
WHERE 
(  (UPPER(sa.rec_message) like UPPER('%login%'))  
   or
   (UPPER(sa.rec_message) like UPPER('%логін%')) )
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEIs3
'' SIG '' J3bcReoutlMThe588bygggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBC0gVv2Ib5csQXu
'' SIG '' FktFPdTiMA0GCSqGSIb3DQEBAQUABEAMIQoUlLXrrKxZ
'' SIG '' ENdYJC5JCeqMmgfEmzNImY5ntA1lkDuP/sgakK50jVZT
'' SIG '' Or/jFQpSB9x7L+vDPt9L4SUaS+8l
