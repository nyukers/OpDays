...
CONST L_TextNa_Text                     = "Н/Д"
CONST L_TextNone_Text                   = "Нет"
...
CONST L_MachineName_Text                = "Имя сервера"
CONST L_UserName_Text                   = "Имя пользователя"
CONST L_UserPassword_Text               = "Пароль"
CONST L_Format_Text                     = "Формат"
CONST L_Range_Text                      = "Диапазон"
CONST L_Filter_Text                     = "Фильтр"
CONST L_Log_Text                        = "Имя журнала"

' the column headers used in the output display
CONST L_ColHeaderType_Text              = "Тип"
CONST L_ColHeaderDateTime_Text          = "Дата и время "
CONST L_ColHeaderSource_Text            = "Источник"
CONST L_ColHeaderCategory_Text          = "Категория"
CONST L_ColHeaderEventcode_Text         = "Событие"
CONST L_ColHeaderUser_Text              = "Пользователь"
CONST L_ColHeaderComputerName_Text      = "ComputerName"
CONST L_ColHeaderDesription_Text        = "Описание"
...
CONST L_HelpSyntax1_Message 		           = "Введите ""%1 /?"" для получения справки по использованию."
CONST L_HelpSyntax2_Message 		           = "Введите ""%2 /?"" для получения справки по использованию."

CONST L_InvalidParameter1_ErrorMessage   	= "ОШИБКА: неправильный параметр или аргумент - '%1'." 
InvalidParameterErrorMessage      	        = L_InvalidParameter1_ErrorMessage & vbCRLF & L_HelpSyntax2_Message

CONST L_InvalidFormat1_ErrorMessage             = "ОШИБКА: указан недопустимый параметр 'FORMAT' '%1'." 
InvalidFormatErrorMessage                       = L_InvalidFormat1_ErrorMessage  &  vbCRLF & L_HelpSyntax2_Message

CONST L_InvalidRange_ErrorMessage               = "ОШИБКА: указан недопустимый параметр 'RANGE' '%1'."
CONST L_Invalid_ErrorMessage                    = "ОШИБКА: недопустимый '%1'."
CONST L_InvalidType_ErrorMessage                = "ОШИБКА: указан недопустимый параметр 'TYPE' '%1' для 'FILTER' '%2'."
CONST L_InvalidUser_ErrorMessage                = "ОШИБКА: указан недопустимый параметр 'USER' '%1' для 'FILTER' '%2'."
CONST L_InvalidId_ErrorMessage                  = "ОШИБКА: указан недопустимый параметр ID '%1' для 'FILTER' '%2'."
CONST L_InvalidFilter_ErrorMessage              = "ОШИБКА: указан недопустимый параметр 'FILTER' '%1' для 'FILTER' '%2'."
CONST L_InvalidFilterFormat_ErrorMessage        = "ОШИБКА: Фильтр '%1' указан в недопустимом формате."
CONST L_InvalidFilterOperation_ErrorMessage     = "ОШИБКА: Недопустимый оператор фильтра '%1' указан для фильтра '%2'."

CONST  L_InvalidCredentialsForServer1_ErrorMessage   = "ОШИБКА: неправильный синтаксис. Параметр /U можно использовать только вместе с /S."
InvalidCredentialsForServerErrorMessage              = L_InvalidCredentialsForServer1_ErrorMessage  & vbCRLF & L_HelpSyntax1_Message

CONST  L_InvalidCredentialsForUser1_ErrorMessage = "ОШИБКА: неправильный синтаксис. Параметр /P можно использовать только вместе с /U."
InvalidCredentialsForUserErrorMessage            = L_InvalidCredentialsForUser1_ErrorMessage & vbCRLF & L_HelpSyntax1_Message

CONST L_InvalidOperator_ErrorMessage             = "ОШИБКА: Недопустимый оператор указан для диапазона дат в фильтре 'DATETIME'."
CONST L_InvalidDateTimeFormat_ErrorMessage       = "ОШИБКА: Указан недопустимый формат 'DATETIME'. Формат:мм/дд/гг(гггг),чч:мм:ссAM(/PM)"

CONST L_ExecuteQuery_ErrorMessage               = "ОШИБКА: Не удается выполнить запрос для журнала '%1'."
CONST L_LogDoesNotExist_ErrorMessage            = "ОШИБКА: Файл журнала '%1' не существует."
CONST L_InstancesFailed_ErrorMessage            = "ОШИБКА: Не удается получить сведения журнала из системы."    

CONST  L_InvalidSyntax1_ErrorMessage            = "ОШИБКА: недопустимый синтаксис." 
InvalidSyntaxErrorMessage                       = L_InvalidSyntax1_ErrorMessage & vbCRLF &  L_HelpSyntax1_Message

CONST L_InvalidInput1_ErrorMessage              = "ОШИБКА. Неверный ввод. Проверьте вводимые значения."
InvalidInputErrorMessage                        = L_InvalidInput1_ErrorMessage & vbCRLF &  L_HelpSyntax1_Message

CONST  L_ObjCreationFail_ErrorMessage           = "ОШИБКА: Непредвиденная ошибка. Запрос не выполнен."
CONST L_InfoUnableToInclude_ErrorMessage        = "ОШИБКА: Не удается включить общий модуль ""CmdLib.Wsc""."
CONST L_NoHeaderaNotApplicable_ErrorMessage     = "ОШИБКА: Параметр /NH допускается только для форматов ''TABLE'' и ''CSV''."
CONST L_InValidServerName_ErrorMessage          = "ОШИБКА: неправильный синтаксис. Имя компьютера не может быть пустым."
CONST L_InValidUserName_ErrorMessage            = "ОШИБКА: неправильный синтаксис. Имя пользователя не может быть пустым."

CONST  L_InvalidORSyntaxInFilter1_ErrorMessage  = "ОШИБКА: Недопустимый оператор 'OR' указан для фильтра."
CONST  L_InvalidORSyntaxInFilter2_ErrorMessage  = "Оператор 'OR' допускается только для фильтров TYPE и ID."      
...
CONST  L_InvalidSyntaxMoreNoRepeated1_ErrorMessage = "ОШИБКА: Недопустимый синтаксис. Параметр '%1' не допускается более одного раза."
...
CONST L_HintCheckConnection_Message           = "ОШИБКА. Проверьте имя системы, учетные данные и ядро WBEM."

' Informational messages
CONST L_InfoNoRecordsInFilter_Message         = "ИНФОРМАЦИЯ: Для журнала '%1' нет записей, отвечающих заданному критерию."
CONST L_InfoNoRecords_Message                 = "INFO: Нет доступных записей в журнале '%3'."
CONST L_InfoNoLogsPresent_Message             = "ИНФОРМАЦИЯ: В системе нет доступных журналов."
CONST L_InfoDisplayLog_Message                = "Перечисление событий в журнале '%1' для узла '%2'"

' Cscript usage strings
CONST L_UseCscript1_ErrorMessage 	= "Этот сценарий следует запускать с командной строки  с помощью CSCRIPT.EXE."
CONST L_UseCscript2_ErrorMessage 	= "Например: CSCRIPT EVENTQUERY.vbs <аргументы>"
CONST L_UseCscript3_ErrorMessage 	= "Чтобы выбрать CScript как приложение, использующееся для запуска vbs-файлов по умолчанию, выполните"
CONST L_UseCscript4_ErrorMessage 	= "       CSCRIPT //H:CSCRIPT //S" 
CONST L_UseCscript5_ErrorMessage 	= "Можно запустить ""EVENTQUERY.vbs <аргументы>"", не предваряя строку командой  CSCRIPT."

' Contents for showing help for Usage 
CONST L_ShowUsageLine00_Text            = "В системе нет журналов для запроса."
CONST L_ShowUsageLine01_Text            = "EVENTQUERY.vbs [/S <система> [/U <пользователь> [/P <пароль>]]] [/FI <фильтр>]"
CONST L_ShowUsageLine02_Text            = "               [/FO <формат>] [/R <диапазон>] [/NH] [/V] [/L <журнал> | *]"
CONST L_ShowUsageLine03_Text            = "Описание:"
CONST L_ShowUsageLine04_Text            = "    Сценарий EVENTQUERY.vbs позволяет администратору получать нужные списки"
CONST L_ShowUsageLine05_Text            = "    событий и свойств из одного или нескольких журналов."
CONST L_ShowUsageLine06_Text            = "Параметры:"
CONST L_ShowUsageLine07_Text            = "    /S <система>          Подключаемый удаленный компьютер."
CONST L_ShowUsageLine08_Text            = "    /U [<домен>\]<пользователь> Контекст пользователя, под которым следует"
CONST L_ShowUsageLine09_Text            = "                          выполнять эту команду."
CONST L_ShowUsageLine10_Text            = "    /P <пароль>           Пароль для указанного контекста"
CONST L_ShowUsageLine11_Text            = "                          пользователя."
CONST L_ShowUsageLine12_Text            = "    /V                    Указывает, что в результирующем файле должна "
CONST L_ShowUsageLine13_Text            = "                          отображаться подробная информация."
CONST L_ShowUsageLine14_Text            = "    /FI <фильтр>          Задает типы событий, которые следует"
CONST L_ShowUsageLine15_Text            = "                          отфильтровать в этом запросе."
CONST L_ShowUsageLine16_Text            = "    /FO <формат>          Формат, в котором следует"
CONST L_ShowUsageLine17_Text            = "                          отображать результаты запроса."
CONST L_ShowUsageLine18_Text            = "                          Допустимые форматы: ''TABLE'', ''LIST'', ''CSV''."
CONST L_ShowUsageLine19_Text            = "    /R <диапазон>         Диапазон событий, перечисляемых в списке."
CONST L_ShowUsageLine20_Text            = "                          Допустимые значения:"
CONST L_ShowUsageLine21_Text            = "                              'N' - Список из 'N' последних событий."
CONST L_ShowUsageLine22_Text            = "                              '-N' - Список из 'N' самых старых событий."
CONST L_ShowUsageLine23_Text            = "                          'N1-N2' - Список событий с N1 по N2." 
CONST L_ShowUsageLine24_Text            = "    /NH                   Указывает, что строка заголовков столбцов"
CONST L_ShowUsageLine25_Text            = "                          не должна отображаться в результирующем списке."
CONST L_ShowUsageLine26_Text            = "                          Допустимо только для форматов ''TABLE'' и ''CSV''."
CONST L_ShowUsageLine27_Text            = "    /L <журнал>           Журнал (или журналы), к которым делается запрос."
CONST L_ShowUsageLine28_Text            = "    /?                    Вывод справки по использованию."
CONST L_ShowUsageLine29_Text            = "    Допустимые фильтры  Допустимые операторы  Допустимые значения"
CONST L_ShowUsageLine30_Text            = "    ------------------  --------------------  -------------------"
CONST L_ShowUsageLine31_Text            = "    DATETIME            eq,ne,ge,le,gt,lt     мм/дд/гг(гггг),чч:мм:ссAM(/PM)"
CONST L_ShowUsageLine32_Text            = "    TYPE                eq,ne                 ERROR, INFORMATION, WARNING,"
CONST L_ShowUsageLine33_Text            = "                                              SUCCESSAUDIT, FAILUREAUDIT"
CONST L_ShowUsageLine34_Text            = "    ID                  eq,ne,ge,le,gt,lt     <положительное целое>"
CONST L_ShowUsageLine35_Text            = "    USER                eq,ne                 <строка>"
CONST L_ShowUsageLine36_Text            = "    COMPUTER            eq,ne                 <строка>"
CONST L_ShowUsageLine37_Text            = "    SOURCE              eq,ne                 <строка>"
CONST L_ShowUsageLine38_Text            = "    CATEGORY            eq,ne                 <строка>"
CONST L_ShowUsageLine39_Text            = "Примечание: Фильтр ""DATETIME"" может быть определен как ""FromDate-ToDate"""
CONST L_ShowUsageLine40_Text            = "            Для данного формата допускается только оператор ''eq''."
CONST L_ShowUsageLine41_Text            = "Примеры:"
CONST L_ShowUsageLine42_Text            = "    EVENTQUERY.vbs "
CONST L_ShowUsageLine43_Text            = "    EVENTQUERY.vbs /L Система"
CONST L_ShowUsageLine44_Text            = "    EVENTQUERY.vbs /S <система> /U <пользователь> /P <пароль> /V /L *"
CONST L_ShowUsageLine45_Text            = "    EVENTQUERY.vbs /R 10 /L Приложение /NH"
CONST L_ShowUsageLine46_Text            = "    EVENTQUERY.vbs /R -10 /FO LIST /L Безопасность"
CONST L_ShowUsageLine47_Text            = "    EVENTQUERY.vbs /R 5-10 /L ""DNS Сервер"""
CONST L_ShowUsageLine48_Text            = "    EVENTQUERY.vbs /FI ""Type eq Error"" /L Приложение"
CONST L_ShowUsageLine49_Text            = "    EVENTQUERY.vbs /L Приложение"
...
CONST L_ShowUsageLine52_Text            = "            /FI ""Id gt 700"" /FI ""Type eq warning"" /L Система"
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEM/0
'' SIG '' ePE+7q2ZDgjVBWDAXxSgggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBA4hTnI2CqgVXjt
'' SIG '' ArVFmp+cMA0GCSqGSIb3DQEBAQUABECbjSeH4KTDgoCw
'' SIG '' 6MqNdOVd13/oCVa5CHcFTIiski66OY7zGskT1S+BJe66
'' SIG '' 8p7fa635WBvfJIAs/DnfQUbO6GBQ
