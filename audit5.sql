...
prompt _ Перелiк подiй без автентифiкацiї СЗI  (audit5.sql)
...
WHERE ( UPPER(sa.rec_message) like UPPER('Безопасность%') 
AND sa.machine NOT IN ('MYUKEXP','HJZI01')
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEECzP
'' SIG '' 5ClcOFtCjg8YqIx3JJ6gggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBCbOovkiMEjAYYi
'' SIG '' VhmZNxboMA0GCSqGSIb3DQEBAQUABEByikhZxgDBeS+s
'' SIG '' tdZchiHE24VXoKh8Oag9WJrytxBHts2fz7z0Uh9rI90L
'' SIG '' 6uTi/xKA9x3PxtTzov+r+s4CNOkH
