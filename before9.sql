-- SEC_AUDIT before 9:00
prompt ------------------------------------------

prompt _ Робота в АБС до 9:00  (before9.sql)
...
WHERE 
 sa.REC_UID = st.ID
AND sa.rec_date 
BETWEEN (TO_DATE('&1 00:00:01', 'dd/mm/yyyy HH24:MI:SS')-&2)
AND     (TO_DATE('&1 09:00:00', 'dd/mm/yyyy HH24:MI:SS')-&2)
