...
prompt _ Дублер в списку користувачів АБС (dubstaff.sql)

prompt ------------------------------------------

col FIO format a25

select s.fio, count(s.tabn)
from staff s
group by s.fio
having ( count(s.tabn)>1 );
/*
'' SIG '' Begin signature block
'' SIG '' MIIDSgYJKoZIhvcNAQcCoIIDOzCCAzcCAQExDjAMBggq
'' SIG '' hkiG9w0CBQUAMGYGCisGAQQBgjcCAQSgWDBWMDIGCisG
'' SIG '' AQQBgjcCAR4wJAIBAQQQTvApFpkntU2P5azhDxfrqwIB
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEENkx
'' SIG '' geHy+LYKvIgy7b6EK5GgggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBCIJV7ZYBAlQWV1
'' SIG '' ZWfEmdzmMA0GCSqGSIb3DQEBAQUABEBpLx4IbJstVQJV
'' SIG '' jK5G5UBXFAeprx6xfXqY/9BHUBFgNXD2B/I/tGCHKphA
'' SIG '' gCAtNkb0N5jBRPHvW77qy0+AFZCq
