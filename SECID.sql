-- TABN from  STAFF kotorix net vSEC_LOGINS
prompt ------------------------------------------

prompt _ TABN з STAFF яких немає в SEC_LOGINS (secid.sql)
...
from staff s
where s.TABN not in (select SECID from  sec_logins)
order by s.id;
/*
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEC4B
'' SIG '' PfsrE4u+l327C4oTpXugggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBDNTL2xizQfSStw
'' SIG '' Jcfg9ERPMA0GCSqGSIb3DQEBAQUABEASTy84SA0BwoPI
'' SIG '' Be+RviKmZNVsdW8v9FU/G0E8p6bhG8/b21YQFXYeRT6l
'' SIG '' M9gO6KaZhbEBhb9k2Tkfq19eue3I
