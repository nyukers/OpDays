-- SEC_AUDIT after 18:00
prompt ------------------------------------------

prompt _ Робота в АБС пiсля 18:00  (auditafter18.sql)

prompt ------------------------------------------

col FIO format a25

select st.TABN, st.fio, 
 TO_CHAR(MAX(sa.rec_date), 'dd/mm/yyyy HH24:MI:SS') as Finish
from sec_audit sa, staff st
WHERE 
 sa.REC_UID = st.ID
AND sa.rec_date 
BETWEEN (TO_DATE('&1 18:00:00', 'dd/mm/yyyy HH24:MI:SS')-&2)
AND     (TO_DATE('&1 23:59:59', 'dd/mm/yyyy HH24:MI:SS')-&2)
group by st.fio, st.TABN
order by Finish;
/*
...
'' SIG '' AAIBAAIBAAIBAAIBADAgMAwGCCqGSIb3DQIFBQAEEMEy
'' SIG '' uh5QYa8lyYsMDDo2ixOgggGrMIIBpzCCAVGgAwIBAgIQ
...
'' SIG '' AYI3AgEVMB8GCSqGSIb3DQEJBDESBBDI74Bt//oVF9B1
'' SIG '' WNhFEQ2wMA0GCSqGSIb3DQEBAQUABECCRGjFZlvoA6zj
'' SIG '' 5qnYZq+B8YvfRg7VCYiPJJVC44RnNACOa4XW0pPWQUMF
'' SIG '' AtMvjnEJWnquoplLhxyAciPbOoor
